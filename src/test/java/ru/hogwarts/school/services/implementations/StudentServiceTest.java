...
class StudentServiceTest {
    ...
    void createStudent_studentIsAlreadyInTable_thrownException() {
        when(testRepository.findByNameAndAge(student.getName(), student.getAge()).isPresent())
                .thenThrow(new StudentException("STUDENT IS ALREADY IN TABLE"));
    ...
    void readStudent_studentIsNotInTable_thrownException() {
        when(testRepository.findById(student.getId())).thenThrow(new StudentException("STUDENT NOT FOUND"));
        StudentException ex = assertThrows(StudentException.class,
    ...
    void updateStudent_studentIsNotInTable_thrownException() {
        when(testRepository.findById(student.getId()).isEmpty()).thenThrow(new StudentException("STUDENT NOT FOUND"));
        StudentException ex = assertThrows(StudentException.class,
